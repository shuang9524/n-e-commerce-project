...
<#-- 规格列表转换 -->
<#assign sepcList=goodsDesc.specificationItems?eval >
<!--页面顶部 结束-->
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${itemCategory1}</a>
					</li>
					<li>
						<a href="#">${itemCategory2}</a>
					</li>
					<li>
						<a href="#">${itemCategory3}</a>
					</li>
				</ul>
			</div>
			<!--product-info-->
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<#if (imageList?size>0)>
							<span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400px" height="350px"/></span>
							</#if>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}"  ng-click="selectedSpec('${spec.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
